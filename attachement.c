...
int main() {
    ...
    char email_headers_and_body[BUFFER_SIZE * 10];
    snprintf(email_headers_and_body, sizeof(email_headers_and_body),
             "From: %s\r\n"
             "To: %s\r\n"
             "Subject: %s\r\n"
             "MIME-Version: 1.0\r\n"
             ...
             "%s\r\n"
             "--boundary1--\r\n.\r\n",
             FROM_EMAIL, TO_EMAIL, SUBJECT, BODY, encoded_file_content);
